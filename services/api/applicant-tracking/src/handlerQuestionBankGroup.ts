...
/**
 * Delete ATQuestionBankGroup.
 */
export const deleteQuestionBankGroup = utilService.gatewayEventHandlerV2(async ({ securityContext, event }: IGatewayEventInput) => {
    console.info('ApplicantTracking.handlerQuestionBankGroup.deleteQuestionBankGroup');
    ...
    const apiResult = await applicantTrackingService.questionBankGroupService.deleteQuestionBankGroup(tenantId, companyId, userEmail, id);
