 ...
 */
export const getHardStatusTypesByTenant = utilService.gatewayEventHandlerV2(async ({ securityContext, event }: IGatewayEventInput) => {
    console.info('ApplicantTracking.handlerHardStatusType.getHardStatusTypesByTenant');
    ...
    return await applicantTrackingService.hardStatusTypeService.getHardStatusTypesByTenant(tenantId, event.queryStringParameters);
});